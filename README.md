...
![Physical graph example](physical_graph_model2.svg "Graph plot of the model 2 mapping ")

![Physical graph example 2](physical_graph_model3.svg "Graph plot of the model 3 mapping ")
